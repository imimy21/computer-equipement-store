...
const cableProducts = [
  { id: 1, name: "HDMI Cable 2m", image: "/cable1.png", price: 1500, description: "High-speed HDMI cable for 4K video and audio transmission." },
  { id: 2, name: "USB-C Cable 1m", image: "/cable2.png", price: 1200, description: "Fast charging and data transfer USB-C cable." },
  { id: 3, name: "Ethernet Cable 3m", image: "/cable3.png", price: 1000, description: "Cat6 Ethernet cable for high-speed internet connection." },
  { id: 4, name: "USB 3.0 Cable", image: "/cable4.png", price: 800, description: "USB 3.0 cable for fast data transfer and charging." },
  { id: 5, name: "Audio Jack 3.5mm", image: "/cable5.png", price: 600, description: "3.5mm audio cable for headphones and speakers." },
  // الكابلات الجديدة المضافة
  { id: 6, name: "DisplayPort Cable", image: "/cable6.png", price: 2000, description: "DisplayPort cable for high-resolution monitors and gaming." },
  { id: 7, name: "Thunderbolt 3 Cable", image: "/cable7.png", price: 3500, description: "Thunderbolt 3 cable for ultra-fast data transfer." },
  { id: 8, name: "VGA Cable", image: "/cable8.png", price: 1200, description: "VGA cable for connecting older monitors and projectors." },
  { id: 9, name: "Power Cable", image: "/cable9.png", price: 800, description: "Standard power cable for computers and devices." },
  { id: 10, name: "SATA Cable", image: "/cable10.png", price: 500, description: "SATA data cable for internal hard drives and SSDs." },
];

function PeripheCable() {
  ...
  return (
    <div className="bg-[#f8f5f9] min-h-screen flex flex-col relative">
      ...
      <p className="text-center text-gray-700 mt-4 mb-6 text-lg">
        Discover our collection of high-quality cables for all your connectivity needs.
      </p>
