...
const headsetProducts = [
  { id: 1, name: "Logitech H390", image: "/headset1.png", price: 4500, description: "Comfortable wired headset with noise-cancelling microphone." },
  { id: 2, name: "HyperX Cloud II", image: "/headset2.png", price: 22000, description: "High-quality gaming headset with surround sound." },
  { id: 3, name: "SteelSeries Arctis 7", image: "/headset3.png", price: 27000, description: "Wireless gaming headset with excellent audio quality." },
  { id: 4, name: "Razer Kraken", image: "/headset4.png", price: 20000, description: "Gaming headset with RGB lighting and strong bass." },
  { id: 5, name: "Corsair HS60", image: "/headset5.png", price: 18000, description: "Comfortable headset for gaming and work." },
];

function PeripheHeadset() {
  ...
  return (
    <div className="bg-[#f8f5f9] min-h-screen flex flex-col relative">
      ...
      <p className="text-center text-gray-700 mt-4 mb-6 text-lg">
        Discover our collection of high-quality headsets.
      </p>
