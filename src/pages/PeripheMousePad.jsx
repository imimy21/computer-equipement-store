...
const mousepadProducts = [
  { id: 1, name: "Corsair MM300", image: "/tapis1.png", price: 3500, description: "Large cloth gaming mouse pad with anti-fray stitched edges." },
  { id: 2, name: "Razer Goliathus", image: "/tapis2.png", price: 4500, description: "Smooth cloth mouse pad for high precision gaming." },
  { id: 3, name: "SteelSeries QcK", image: "/tapis3.png", price: 2500, description: "Popular soft mouse pad for everyday use and gaming." },
  { id: 4, name: "Logitech G440", image: "/tapis4.png", price: 5500, description: "Hard surface mouse pad for low friction and speed." },
  { id: 5, name: "HyperX Fury S", image: "/tapis5.png", price: 4000, description: "Durable gaming mouse pad with consistent glide." },
];

function PeripheMousePad() {
  ...
  return (
    <div className="bg-[#f8f5f9] min-h-screen flex flex-col relative">
      ...
      <p className="text-center text-gray-700 mt-4 mb-6 text-lg">
        Browse our collection of mouse pads, perfect for gaming, work, and everyday use.
      </p>
...
export default PeripheMousePad;