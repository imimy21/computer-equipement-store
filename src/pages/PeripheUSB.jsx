...
const usbProducts = [
  { id: 1, name: "SanDisk 32GB", image: "/usb1.png", price: 1200, description: "Compact and reliable USB drive for everyday use." },
  { id: 2, name: "Kingston 64GB", image: "/usb2.png", price: 2200, description: "High-speed USB 3.0 drive for faster data transfer." },
  { id: 3, name: "Samsung 128GB", image: "/usb3.png", price: 4500, description: "Durable USB drive with high storage capacity." },
  { id: 4, name: "Corsair 64GB", image: "/usb4.png", price: 3000, description: "Stylish and compact USB drive for all devices." },
  { id: 5, name: "PNY 256GB", image: "/usb5.png", price: 9000, description: "High-capacity USB drive for professional use." },
];
  ...
  return (
    <div className="bg-[#f8f5f9] min-h-screen flex flex-col relative">
      ...
      <p className="text-center text-gray-700 mt-4 mb-6 text-lg">
        Discover our collection of high-speed and reliable USB drives.
      </p>
